 ...
 *
 * @uses       \DbUnit\DataSet\AbstractTable
 * @category   Zend
 * @package    Zend_Test
 * @subpackage PHPUnit
 * @copyright  Copyright (c) 2005-2015 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Test_PHPUnit_Db_DataSet_DbRowset extends \DbUnit\DataSet\AbstractTable
{
    /**
    ...
    public function __construct(Zend_Db_Table_Rowset_Abstract $rowset, $tableName = null)
    {
        ...
        $this->tableMetaData = new \DbUnit\DataSet\DefaultTableMetaData($this->tableName, $columns);
    }
}
