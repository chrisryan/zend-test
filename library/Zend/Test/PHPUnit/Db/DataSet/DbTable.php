 ...
 *
 * @uses       \DbUnit\DataSet\QueryTable
 * @category   Zend
 * @package    Zend_Test
 * @subpackage PHPUnit
 * @copyright  Copyright (c) 2005-2015 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Test_PHPUnit_Db_DataSet_DbTable extends \DbUnit\DataSet\QueryTable
{
    /**
    ...
    protected function createTableMetaData()
    {
        if ($this->tableMetaData === NULL) {
            $this->loadData();
            $this->tableMetaData = new \DbUnit\DataSet\DefaultTableMetaData($this->tableName, $this->_columns);
        }
    }
}
