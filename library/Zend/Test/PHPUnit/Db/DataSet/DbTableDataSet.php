 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Test_PHPUnit_Db_DataSet_DbTableDataSet extends \DbUnit\DataSet\AbstractDataSet
{
    /**
     * @var array
     */
    ...
    {
        return new \DbUnit\DataSet\DefaultTableIterator($this->tables, $reverse);
    }
